...
HD_PWD='D:/AN3/SSC/Laborator4_add_multiply/Sumator_Inmultitor/Sumator_Inmultitor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log muxSelectie.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source muxSelectie.tcl
