...
HD_PWD='D:/AN3/SSC/Laborator4_add_multiply/Sumator_Inmultitor/Sumator_Inmultitor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log muxSelectie.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source muxSelectie.tcl -notrace
