...
--1.    addi $4,$0,6    #$4 -> salvam nr de iteratii 
--2.    add $2,$0,$0    #
--3.    add $5,$0,$0    #$5 -> sum
...
--introducere NoOp pentru rezolvarea hazardurilor
...
B"000_000_000_000_0_000", --NoOp -5
B"000_000_000_000_0_000", --NoOp -6
B"000_000_000_000_0_000", --NoOp -7
B"010_010_011_0000000", --"4980" -8
B"000_101_011_101_0_000",   --"15d0" -9
B"111_010_010_0000010",   --"E902 "-10
B"111_001_001_0000010",   --"E482" -11
B"001_0000000000100",   --"2004" -12. j4
B"000_0000000000000",   --"0000" -13. No op
B"101_000_101_0010000",  --"A290" -14. sw $5, 16($0)
others=>x"0000"
);
