...
HD_PWD='D:/sem2/PSN/proiect/finalProiect/test/test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log afis_buton.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source afis_buton.tcl -notrace
